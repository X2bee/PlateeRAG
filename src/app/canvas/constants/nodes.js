                ...
                nodes: [
                    {
                        ...
                        parameters: [
                            { id: 'p-model', name: 'Model', value: 'gpt-4o', optional: false, options: [
                            ...
                            { id: 'p-top-p', name: 'Top P', value: 1.0, step: 0.1, min: 0, max: 1, optional: true },
                            { id: 'p-frequency-penalty', name: 'Frequency Penalty', value: 0, step: 0.1, min: -2, max: 2, optional: true },
                            { id: 'p-presence-penalty', name: 'Presence Penalty', value: 0, step: 0.1, min: -2, max: 2, optional: true },
                        ],
                        outputs: [
                ...
                nodes: [
                    {
                        ...
                        parameters: [
                            ...
                            { id: 'p-length', name: 'Max Length', value: 100, optional: true },
                            { id: 'p-uppercase', name: 'Uppercase', value: false, optional: true, options: [
