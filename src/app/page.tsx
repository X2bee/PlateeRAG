...
import { FiArrowRight, FiGithub, FiPlay, FiZap, FiGrid, FiUsers } from "react-icons/fi";
                ...
                <nav className={styles.nav}>
                    <div className={styles.navContent}>
                        ...
                        <div className={styles.navActions}>
                            ...
                            <Link href="/canvas" className={styles.getStartedBtn}>
                                Get Started
                                <FiArrowRight />
                            </Link>
                        </div>
            ...
            <main className={styles.main}>
                <div className={styles.heroSection}>
                    <h1 className={styles.heroTitle}>
                        Build AI Workflows
                        <span className={styles.highlight}>Visually & Intuitively</span>
                    </h1>
                    <p className={styles.heroDescription}>
                        PlateerRAG는 드래그 앤 드롭으로 AI 워크플로우를 구축할 수 있는 비주얼 에디터입니다.<br></br>
                ...
                <div id="features" className={styles.featuresSection}>
                    <div className={styles.featuresHeader}>
                        <h2>핵심 기능</h2>
                        <p>PlateerRAG가 제공하는 강력한 기능들을 확인해보세요</p>
                    </div>
                    ...
                    <div className={styles.featuresGrid}>
                        <div className={styles.featureCard}>
                            ...
                            <div className={styles.cardContent}>
                                ...
                                <p className={styles.cardDescription}>
                                    드래그 앤 드롭으로 노드를 연결하여 복잡한 AI 워크플로우를 시각적으로 구성할 수 있습니다.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className={styles.featureCard}>
                            ...
                            <div className={styles.cardContent}>
                                ...
                                <p className={styles.cardDescription}>
                                    구성한 워크플로우를 실시간으로 실행하고 결과를 즉시 확인할 수 있습니다.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className={styles.featureCard}>
                            ...
                            <div className={styles.cardContent}>
                                ...
                                <p className={styles.cardDescription}>
                                    팀원들과 함께 워크플로우를 공유하고 협업할 수 있는 환경을 제공합니다.
                                </p>
                            </div>
                        </div>
                    </div>
