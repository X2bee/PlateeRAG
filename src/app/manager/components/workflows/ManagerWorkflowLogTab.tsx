...
import { getAllIOLogs } from '@/app/manager/api/workflow';
import { devLog } from '@/app/_common/utils/logger';
import { showValidationErrorToastKo } from '@/app/_common/utils/toastUtilsKo';
import styles from '@/app/manager/assets/ManagerWorkflowLogTab.module.scss';
import ManagerWorkflowChatLogsDetailModal from './ManagerWorkflowChatLogsDetailModal';
...
interface ManagerWorkflowLogTabProps {
    workflowId: string;
    workflowName: string;
}

const ManagerWorkflowLogTab: React.FC<ManagerWorkflowLogTabProps> = ({ workflowId, workflowName }) => {
    ...
    return (
        <div className={styles.container}>
            ...
            {/* 모달 */}
            <ManagerWorkflowChatLogsDetailModal
                isOpen={isModalOpen}
...
export default ManagerWorkflowLogTab;
