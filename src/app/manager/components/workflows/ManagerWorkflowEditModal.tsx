...
import styles from '@/app/manager/assets/workflows/ManagerWorkflowEditModal.module.scss';
import { updateWorkflow } from '@/app/manager/api/workflow';
...
interface ManagerWorkflowEditModalProps {
    workflow: ManagerWorkflow;
    isOpen: boolean;
    onClose: () => void;
    onUpdate: (updatedWorkflow: ManagerWorkflow, updatedDeploy: {[key: string]: boolean | 'pending' | null}) => void;
}

const ManagerWorkflowEditModal: React.FC<ManagerWorkflowEditModalProps> = ({
    workflow,
    isOpen,
    onClose,
    onUpdate
...
export default ManagerWorkflowEditModal;
