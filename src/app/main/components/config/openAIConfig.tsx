...
const OPENAI_CONFIG_FIELDS: Record<string, FieldConfig> = {
    OPENAI_API_KEY: {
        ...
        placeholder: 'sk-...',
        description:
            'OpenAI API 키를 입력하세요. API 키는 안전하게 암호화되어 저장됩니다.',
        required: true,
    },
    OPENAI_API_BASE_URL: {
        label: 'API Base URL',
        ...
        description:
            'OpenAI API의 기본 URL입니다. 프록시나 대체 엔드포인트를 사용하는 경우 변경하세요.',
        required: false,
    },
    ...
    OPENAI_TEMPERATURE_DEFAULT: {
        ...
        step: 0.01,
        description:
            '0에 가까울수록 일관된 답변, 2에 가까울수록 창의적인 답변을 생성합니다. (기본값: 0.7)',
        required: false,
    },
    OPENAI_MAX_TOKENS_DEFAULT: {
        ...
        max: 32000,
        description:
            '응답에서 생성할 최대 토큰 수입니다. (1 토큰 ≈ 4글자, 기본값: 1000)',
        required: false,
    },
    OPENAI_ORGANIZATION_ID: {
        ...
        placeholder: 'org-...',
        description:
            'OpenAI Organization에 속해 있는 경우 Organization ID를 입력하세요.',
        required: false,
    },
};
