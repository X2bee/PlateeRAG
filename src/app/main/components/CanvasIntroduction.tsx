      ...
      <div className={styles.additionalInfo}>
        ...
        <div className={styles.infoGrid}>
          <div className={styles.infoCard}>
            <h4>조건부 실행</h4>
            <p>특정 조건에 따라 워크플로우의 실행 경로를 분기할 수 있습니다. if-else 로직을 시각적으로 구성하여 복잡한 비즈니스 로직을 처리하세요.</p>
          </div>
          
          <div className={styles.infoCard}>
            <h4>병렬 처리</h4>
            <p>여러 노드를 동시에 실행하여 처리 성능을 향상시킬 수 있습니다. 대용량 데이터 처리나 복잡한 AI 모델 추론에 유용합니다.</p>
          </div>
          
          <div className={styles.infoCard}>
            <h4>오류 처리</h4>
            <p>워크플로우 실행 중 발생할 수 있는 오류를 미리 정의하고 처리할 수 있습니다. 안정적인 서비스 운영을 위한 필수 기능입니다.</p>
          </div>
        </div>
      </div>
      ...
      <div className={styles.additionalInfo}>
        ...
        <div className={styles.tipsList}>
          <div className={styles.tip}>
            <h4>💡 메모리 효율성</h4>
            <p>대용량 데이터를 처리할 때는 스트리밍 방식을 사용하여 메모리 사용량을 최적화하세요.</p>
          </div>
          
          <div className={styles.tip}>
            <h4>⚡ 캐싱 활용</h4>
            <p>반복적으로 사용되는 데이터는 캐싱을 통해 처리 속도를 향상시킬 수 있습니다.</p>
          </div>
          
          <div className={styles.tip}>
            <h4>🔄 배치 처리</h4>
            <p>개별 요청보다는 배치 단위로 처리하여 전체적인 처리량을 증가시키세요.</p>
          </div>
          
          <div className={styles.tip}>
            <h4>📊 모니터링</h4>
            <p>실시간 모니터링을 통해 병목 지점을 파악하고 성능을 개선하세요.</p>
          </div>
        </div>
      </div>
    </div>
