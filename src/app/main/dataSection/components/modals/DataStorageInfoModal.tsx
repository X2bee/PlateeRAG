...
import styles from '@/app/main/dataSection/assets/DataStorageInfoModal.module.scss';
...
const DataStorageInfoModal: React.FC<DataStorageInfoModalProps> = ({
    dataset,
    isOpen,
    onClose,
}) => {
...
export default DataStorageInfoModal;
