...
import TaskSelector from '@/app/main/modelSection/components/Eval/TaskSelector';
import PopupSelector from '@/app/main/modelSection/components/Eval/SelectionPopup';
import JobDetailModal from '@/app/main/modelSection/components/Eval/JobDetailModal';
import EvaluationTable from '@/app/main/modelSection/components/Eval/EvaluationTable';
import ModelStorageModal from '@/app/main/modelSection/components/Train/ModelStorageModal'; // 추가

import styles from '@/app/main/modelSection/assets/Eval.module.scss';
