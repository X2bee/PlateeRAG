...
import ModelCategory from '@/app/main/modelSection/components/Train/ModelCategory';
import DataCategory from '@/app/main/modelSection/components/Train/DataCategory';
import TrainerCategory from '@/app/main/modelSection/components/Train/TrainerCategory';
import styles from '@/app/main/modelSection/assets/Train.module.scss';
