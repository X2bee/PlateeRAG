...
<div align="center">
  <img src="./img/main.png" alt="PolarOps Main Screen" width="100%" style="border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);" />
</div>
...
PolarOps is an innovative platform that allows you to build AI applications with a **visual workflow editor**. You can design LangChain-based AI pipelines simply through **drag-and-drop** without complex coding, and communicate naturally with AI through **real-time chat**.
...
<div align="center">
  <img src="./img/canvas.png" alt="PolarOps Canvas Editor" width="80%" style="border-radius: 8px; margin: 20px 0; box-shadow: 0 4px 15px rgba(0,0,0,0.1);" />
...
PolarOps supports various AI nodes from the **LangChain** ecosystem:
...
Meet PolarOps at [http://localhost:3000](http://localhost:3000)! 🎉
...
PolarOps provides a **smart debug logger**:
...
Thank you for contributing to the PolarOps project!
...
- **GitHub Repository**: [PolarOps Repository](https://github.com/plateer/plateerag)
